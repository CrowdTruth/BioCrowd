@if (Auth::user()->check())
	<div class="section group" id="banner" align='center'>
		<div class="col span_3_of_8">
			<a href="biocrowd" style="text-decoration: none;" ><div id="gameLogo" width="400px">{{ Lang::get('gamelabels.logoText') }}</div></a>
		</div>
...
@if (!Auth::user()->check())
	<div class="section group" id="banner" align='center'>
		<div class="col span_4_of_8">
			<a href="biocrowd"><img src="img/logo/logo_games-02.png" width="400px"></a>
		</div>
