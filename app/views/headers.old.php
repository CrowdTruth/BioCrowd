NOTE: 
  These scripts have been removed from main blade template. They can be 
  imported only when needed use @section('extraheaders') (on layout.blade template)
  to include scripts when required
