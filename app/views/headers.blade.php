...
{{-- TODO: Maybe move these scripts to be imported only when needed 
  + keep header clean as much as possible. 
  + use @section('extraheaders') when possible
  + find out the difference between bootstrap.* and bootstrap.min.*
